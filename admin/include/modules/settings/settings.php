      ...
      <div class="tab-content pt-3">
         ...
         <br>
             ...
             <div class="setting-tab-content" data-tab="9" >
               ...
               <div class="form-group row d-flex align-items-center mb-5">
                  <label class="col-lg-3 form-control-label">Подтверждение номера телефона по смс</label>
                  <div class="col-lg-9">
                      <label>
                        <input class="toggle-checkbox-sm" type="checkbox" name="confirmation_phone" value="1" <?php if($settings["confirmation_phone"] == 1){ echo ' checked=""'; } ?> >
                        <span><span></span></span>
                      </label>
                  </div>
               </div>
             ...
             <div class="setting-tab-content" data-tab="11" >
               ...
               <div class="form-group row d-flex align-items-center mb-5">
                  <label class="col-lg-3 form-control-label">Стоимость подключения магазина</label>
                  <div class="col-lg-2">
                     
                     <div class="input-group mb-2">
                        <input type="number" step="any" class="form-control" name="user_shop_price_month" value="<?php echo $settings["user_shop_price_month"]; ?>" >
                        <div class="input-group-prepend">
                           <div class="input-group-text"><?php echo $settings["currency_main"]["sign"]; ?></div>
                        </div>                       
                     </div>
               ...
               <div class="form-group row d-flex align-items-center mb-5">
                  <label class="col-lg-3 form-control-label">Скидка на подключение магазина</label>
                  <div class="col-lg-9">
                     <label>
                        <input class="toggle-checkbox-sm" type="checkbox" name="user_shop_discount_status" value="1" <?php if($settings["user_shop_discount_month"]){ echo 'checked=""'; } ?> >
                        <span><span></span></span>
                     </label>
                  </div>
               </div>

               <div class="settings-shop-discount" <?php if($settings["user_shop_discount_month"]){ echo 'style="display: block;"'; }else{ echo 'style="display: none;"'; } ?> >

                  <div class="form-group row d-flex align-items-center mb-5">
                     <label class="col-lg-3 form-control-label">Применять скидку от</label>
                     <div class="col-lg-2">
                        
                        <input type="number" step="any" name="user_shop_discount_month" class="form-control" value="<?php echo $settings["user_shop_discount_month"]; ?>" >
                        
                        <div class="mt10" >
                           <small>Укажите с какого месяца будет применяться скидка</small>
                        </div>
                  ...
                  <div class="form-group row d-flex align-items-center mb-5">
                     <label class="col-lg-3 form-control-label">Процент скидки</label>
                     <div class="col-lg-2">
                        
                        <div class="input-group mb-2">
                           <input type="text" class="form-control" name="user_shop_discount_percent" value="<?php echo $settings["user_shop_discount_percent"]; ?>" >
                           <div class="input-group-prepend">
            ...
            <?php } ?>
             ...
             <div class="form-group row d-flex align-items-center mb-5">
                <label class="col-lg-3 form-control-label">Метод</label>
                <div class="col-lg-9">
                   <select name="authorization_option" class="selectpicker">
                      
                      <option value="2"  <?php if($settings["authorization_option"] == 2){ echo ' selected=""'; } ?> >По e-mail/номеру телефона и паролю</option>
                      <option value="1"  <?php if($settings["authorization_option"] == 1){ echo ' selected=""'; } ?> >По номеру телефона и паролю</option>
                      <option value="3"  <?php if($settings["authorization_option"] == 3){ echo ' selected=""'; } ?> >По e-mail и паролю</option>
             ...
             <div class="form-group row d-flex align-items-center mb-5">
                ...
                <div class="col-lg-2">
                   ...
                   <input type="text" name="format_phone" class="form-control" value="<?php echo $settings["format_phone"]; ?>" >
                   <small>Оставьте это поле пустым если формат не требуется</small>

                </div>
             </div>

             <div class="form-group row d-flex align-items-center mb-5">
                <label class="col-lg-3 form-control-label">Социальные сети</label>
                <div class="col-lg-9">
             ...
             <div class="form-group row d-flex align-items-center mb-5">
              ...
              <div class="form-group row d-flex align-items-center mb-5">
                ...
                <div class="col-lg-5">
                     <input type="text" class="form-control" value="<?php echo $settings["social_link_fb"]; ?>" name="social_link_fb" >
                </div>
              </div>
              ...
              <div class="form-group row d-flex align-items-center mb-5">
                ...
                <div class="col-lg-5">
                     <input type="text" class="form-control" value="<?php echo $settings["social_link_inst"]; ?>" name="social_link_inst" >
                </div>
              </div>              
         ...
         <div class="tab-pane fade <?php if($_GET["tab"] == "integrations"){ echo 'active show'; } ?>" id="j-tab-9" role="tabpanel" aria-labelledby="just-tab-9">
                       ...
                       <?php
                         if($config["sms_services"]){
                             foreach ($config["sms_services"] as $name => $value) {
                                 ?>
                                 <option <?php if($name == $settings["sms_service"]){ echo 'selected=""'; } ?> value="<?php echo $name; ?>" data-param="<?php echo $value["param"]; ?>" data-label="<?php echo $value["label"]; ?>" ><?php echo $name; ?></option>
                                 <?php
                             }
                         }
                       ?>
              ...
              <div class="sms_service_id" <?php if( $config["sms_services"][$settings["sms_service"]]["param"] == "id" ){ echo 'style="display: block;"'; } ?> >
                ...
                <?php if($settings["sms_service_id"]){ ?>
                  ...
                  <div class="form-group row d-flex align-items-center mb-5">
                    <label class="col-lg-3 form-control-label"></label>
                    <div class="col-lg-5">
                         <a data-toggle="modal" data-target="#modal-log" class="test-send-sms btn btn-primary" >Тестовая отправка смс</a>
                    </div>
                  </div>
            ...
            <div class="form-group row d-flex align-items-center mb-5">
              <label class="col-lg-3 form-control-label">Сообщение при отправке кода подтверждения</label>
              <div class="col-lg-5">
             ...
             <div class="form-group row d-flex align-items-center mb-5">
              ...
              <div class="form-group row d-flex align-items-center mb-5">
                <label class="col-lg-3 form-control-label"></label>
                <div class="col-lg-6">
                    <h3> <strong>Подключение соц. сетей для авторизации</strong> </h3>
                </div>
              </div>
              ...
              <div class="form-group row d-flex align-items-center mb-5">
                ...
                <div class="col-lg-5">
                     ...
                     <input type="text" class="form-control mt5" value="<?php echo $social_auth_params["vk"]["id_app"] ?>"  name="social_auth_params[vk][id_app]" >  
