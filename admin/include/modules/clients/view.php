                ...
                <form class="form-horizontal form-edit-user" >
                  ...
                  <?php
                   ...
                   <div class="form-group row d-flex align-items-center mb-5">
                      <label class="col-lg-2 form-control-label d-flex justify-content-lg-end">Магазин</label>
                      <div class="col-lg-6">
                          <a target="_blank" href="<?php echo $Shop->link($data["shop"]["clients_shops_id_hash"]); ?>"  ><?php echo $data["shop"]["clients_shops_title"]; ?></a>
                      </div>
                   </div>
