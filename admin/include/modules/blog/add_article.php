...
<div class="row">
   <div class="page-header">
      <div class="d-flex align-items-center">
         <h2 class="page-header-title">Новая публикация</h2>
         <div>
            <ul class="breadcrumb">
...
<div class="row" >
   <div class="col-lg-12" >
         ...
         <div class="widget-body">
            ...
            <form class="form-data" >
              ...
              <div class="form-group row d-flex align-items-center mb-5">
                ...
                <div class="col-lg-7">
                     <input type="text" class="form-control setTranslate" name="title" >
                </div>
              </div>
      ...
      <p align="right" >
        <button type="button" class="btn btn-success add-article">Добавить</button>
      </p>
