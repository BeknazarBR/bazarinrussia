                     ...
                     <td>
                      <?php
                        if( !$value["secure_payments_errors"] ){
                          ...
                          ?>
                          <span style="color: red;" data-toggle="popover" data-trigger="hover" data-placement="bottom" data-content='Ошибка: <?php echo $value["secure_payments_errors"]; ?>' >Ошибка при выплате <i class="la la-info-circle"></i></span>
