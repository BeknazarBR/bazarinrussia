$(document).ready(function() {
    ...
    $('.button_country_add').click(function (e) {
        var data_form = $("#form-data-country-add").serialize();    
        $('.proccess_load').show(); 
        $.ajax({type: "POST",url: "include/modules/cities/handlers/add.php",data: data_form,dataType: "html", cache: false,                     
    ...
    $('.button_country_edit').click(function (e) {
        var data_form = $("#form-data-country-edit").serialize();    
        $('.proccess_load').show(); 
        $.ajax({type: "POST",url: "include/modules/cities/handlers/edit.php",data: data_form,dataType: "html",cache: false,                     
            success: function (data) {
                if(data == true){location.reload(); }else{$('.proccess_load').hide(); notification(); }                                           
            }
        });
