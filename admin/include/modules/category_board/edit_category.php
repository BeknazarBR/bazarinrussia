      ...
      <div class="widget has-shadow">
         ...
         <div class="widget-body">
            ...
            <form class="form-data" >
              ...
              <div class="form-group row d-flex align-items-center mb-5">
                <label class="col-lg-3 form-control-label">Применять к подкатегориям</label>
                <div class="col-lg-7">
                    <label>
                    ...
                    <div class="alert alert-primary" role="alert">
                      У данной категории есть вложенные категории, если вы хотите применить данные настройки ко всем вложенным категориям, то активируйте этот тумблер.
                    </div>
