      ...
      <ul class="list-unstyled">
         ...
         <li>
            ...
            <ul id="dropdown1" class="collapse list-unstyled pt-0 <?php if(in_array( $_GET["route"], array("board","category_board","services_ad","add_category_board","edit_category_board", "complaints", "filters") )){ ?> show <?php } ?>" >
               ...
               <li><a <?php if($_GET["route"] == "services_ad"){ echo 'class="active"'; } ?> href="?route=services_ad">Платные услуги</a></li>
               <li><a <?php if($_GET["route"] == "complaints"){ echo 'class="active"'; } ?> href="?route=complaints">Жалобы <?php if($getComplain){ ?> <span class="label-count" ><?php echo $getComplain; ?></span> <?php } ?> </a></li>
            </ul>
         </li>
         <?php 
         ...
         <li>
            <a href="#dropdown4" <?php if(in_array( $_GET["route"], array("advertising","seo","seo_filters","add_seo_filter","edit_seo_filter","ads_feed","promo_slider", "promo_pages", "rss") )){ ?> aria-expanded="true" <?php }else{ ?> aria-expanded="false" <?php } ?> data-toggle="collapse"><i class="la la-bolt"></i><span>Инструменты</span></a>
            <ul id="dropdown4" class="collapse list-unstyled pt-0 <?php if(in_array( $_GET["route"], array("advertising","ads_import","seo","seo_filters","add_seo_filter","edit_seo_filter","ads_feed","promo_slider", "promo_pages", "rss") )){ ?> show <?php } ?>">
