...
<nav class="navbar fixed-top">
   <div class="navbar-holder d-flex align-items-center align-middle justify-content-between">
      <div class="navbar-header">
         <a href="/<?php echo $config["folder_admin"]; ?>" class="navbar-brand">
      ...
      <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center pull-right">
         ...
         <?php if($_SESSION["cp_control_statistics"] && $_SESSION["cp_control_board"]){ ?>
         <li class="nav-item dropdown notification-alert">

               <a rel="nofollow" data-target="#" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link">
               ...
               <ul aria-labelledby="notifications" class="dropdown-menu notification"></ul>
