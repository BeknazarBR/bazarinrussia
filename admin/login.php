    ...
    <script type="text/javascript">
      $(document).ready(function () {
        ...
        $(".form-auth").on("submit", function (e) {
            $(".alert-danger").hide();          
                $.ajax({
                    type: "POST",url: url_path + "systems/ajax/admin.php",data: $( this ).serialize()+"&action=auth",dataType: "json",cache: false,
       ...
       $(".form-remind").on("submit", function (e) { 
            ...
            $(".alert-success").hide();
                $.ajax({
                    type: "POST",url: url_path + "systems/ajax/admin.php",data: $( this ).serialize()+"&action=remind",dataType: "html",cache: false,
                    success: function (data) {
