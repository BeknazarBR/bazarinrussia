		...
		if(count($cart)){
				...
				foreach ($cart as $id => $value) {
						...
						';
                      	...
                      	$getShop = findOne( "uni_clients_shops", "clients_shops_time_validity > now() and clients_shops_id_user=?", [ $value['ad']["ads_id_user"] ] );

                      	if( $getShop ){
                          $link = '<a href="'.$Shop->link($getShop["clients_shops_id_hash"]).'" class="cart-goods-item-content-seller"  >'.$getShop["clients_shops_title"].'</a>';
                      	}else{
				...
				$container = '
				      ...
				      <div class="cart-buttons" >
				          ...
				          <div class="btn-custom btn-color-blue schema-color-button cart-order mb5" data-page-type="'.$settings["marketplace_view_cart"].'" >
