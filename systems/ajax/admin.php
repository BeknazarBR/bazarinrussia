...
if(isAjax() == true){
    ...
    if($_POST["action"] == "notifications_toolbar"){
          
          $get = getAll("select * from uni_notifications");
          ...
          if(count($get) > 0){
          	...
          	$alert = '
	            <li>
	              <div class="notifications-header">
	                 ...
	                 <img src="'.$config["urlPath"] . "/" . $config["folder_admin"] .'/files/images/notifications-header.png" class="img-fluid">
	              </div>
	            </li>
          	';
            ...
            if($value["count"] > 1){ $count = "(".$value["count"].")"; } else { $count = ""; }

          	$alert .= '
	               <li>
	                  <a href="'.$value["link"].'&open_toolbar='.$value["id"].'">
	                     ...
	                     <div class="message-body">
	                        ...
	                        <span class="date">'.datetime_format_cp($value["datetime"]).'</span>
	                     </div>
	                  </a>
	               </li>
          	';
