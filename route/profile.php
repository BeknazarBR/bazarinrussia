...
$array_tabs = array("ad", "sold", "archive" , "orders", "favorites", "settings", "balance", "history", "reviews", "subscriptions", "shop");
...
if( $data["advanced"] ){
  ...
  $data["shop"] = findOne("uni_clients_shops", "clients_shops_id_user=?", [$_SESSION['profile']['id']] );
