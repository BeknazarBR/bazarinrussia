...
return [
   ...
   "https" => false,
   "private_hash" => "26ad6b09a51b082e2032c387df2844aa",
   "private_hex" => "5b9bdeba27a41192505c9c682cf1afa0",
   "feed_ads_key" => "65837830",
   "cron_key" => "84792091",
   "folder_admin" => "admin",
   "basePath" => __dir__,
   "urlPrefix" => "/",
   "urlPath" => "https://bazaarinrussia.com",
   ...
   "css_styles" => [
        '<link href="{urlPath}/{templateFolder}/css/line-awesome.min.css" rel="stylesheet">',
    '<link href="https://fonts.googleapis.com/css2?family=Open+Sans:wght@300;400;600;700&family=Roboto:wght@100;300&display=swap" rel="stylesheet">',
        '<link href="{urlPath}/{templateFolder}/css/bootstrap.min.css" rel="stylesheet">',
        '<link href="{urlPath}/{templateFolder}/css/ionicons/ionicons.min.css" rel="stylesheet">',
        '<link href="{urlPath}/{templateFolder}/css/styles.css" rel="stylesheet">',
        '<link href="{urlPath}/{templateFolder}/js/owl-carousel/owl.carousel.min.css" rel="stylesheet">',
    '<link href="{urlPath}/{templateFolder}/js/owl-carousel/owl.theme.default.css" rel="stylesheet">',
        '<link href="{urlPath}/{templateFolder}/js/slick/slick-theme.css" rel="stylesheet">',
        '<link href="{urlPath}/{templateFolder}/js/slick/slick.css" rel="stylesheet">',
    '<link href="{urlPath}/{templateFolder}/css/lightgallery.css" rel="stylesheet">',
    '<link href="{urlPath}/{templateFolder}/css/lightslider.css" rel="stylesheet">',
        '<link href="{urlPath}/{templateFolder}/js/dragula/dragula.min.css" rel="stylesheet">',
        '<link href="{urlPath}/{templateFolder}/js/ion/css/ion.rangeSlider.min.css" rel="stylesheet">',
    '<link href="{urlPath}/{templateFolder}/css/animate.css" rel="stylesheet">',
    '<link href="{urlPath}/{templateFolder}/js/summernote/summernote-lite.css" rel="stylesheet">',
    '<link href="{urlPath}/{templateFolder}/js/summernote/summernote.min.css" rel="stylesheet">',
    '<link href="{urlPath}/{templateFolder}/js/summernote/summernote-bs4.css" rel="stylesheet">',
    '<link href="{urlPath}/{templateFolder}/js/minicolors/jquery.minicolors.css" rel="stylesheet">',
    '<link href="{urlPath}/{templateFolder}/js/dropzone/dropzone.min.css" rel="stylesheet">',
    '<link rel="manifest" href="{urlPath}/manifest.json">',
   ],

   "js_plugins" => [
        '<script src="{urlPath}/{templateFolder}/js/jquery-1.11.1.min.js"></script>',
        '<script src="{urlPath}/{templateFolder}/js/bootstrap.bundle.min.js"></script>',
        '<script src="{urlPath}/{templateFolder}/js/bootstrap.bundle.js"></script>',
        '<script src="{urlPath}/{templateFolder}/js/popper.min.js"></script>',
        '<script src="{urlPath}/{templateFolder}/js/bootstrap.min.js"></script>',   
        '<script src="{urlPath}/{templateFolder}/js/jquery.cookie.js"></script>',
    '<script src="{urlPath}/{templateFolder}/js/owl-carousel/owl.carousel.min.js"></script>',
        '<script src="{urlPath}/{templateFolder}/js/slick/slick.min.js"></script>',
    '<script src="{urlPath}/{templateFolder}/js/unisite-select.js"></script>',
        '<script src="{urlPath}/{templateFolder}/js/vendor.js"></script>',
        '<script src="{urlPath}/{templateFolder}/js/cart.js"></script>',
        '<script src="https://cdn.jsdelivr.net/picturefill/2.3.1/picturefill.min.js"></script>',
    '<script src="{urlPath}/{templateFolder}/js/lightgallery.min.js"></script>',
    '<script src="{urlPath}/{templateFolder}/js/lightslider.min.js"></script>',
        '<script src="{urlPath}/{templateFolder}/js/lg-zoom.min.js"></script>',
        '<script src="{urlPath}/{templateFolder}/js/lg-thumbnail.min.js"></script>',
        '<script src="{urlPath}/{templateFolder}/js/lg-video.js"></script>',
        '<script src="{urlPath}/{templateFolder}/js/lg-autoplay.js"></script>',
        '<script src="{urlPath}/{templateFolder}/js/ion/js/ion.rangeSlider.min.js"></script>',
        '<script src="{urlPath}/{templateFolder}/js/jquery-inputformat.min.js"></script>',
        '<script src="{urlPath}/{templateFolder}/js/dragula/dragula.min.js"></script>',
    '<script src="{urlPath}/{templateFolder}/js/jquery.maskedinput.min.js"></script>',
        '<script src="{urlPath}/{templateFolder}/js/jquery.countdown.min.js"></script>',
    '<script src="{urlPath}/{templateFolder}/js/auth.js"></script>',
    '<script src="{urlPath}/{templateFolder}/js/tippy.all.min.js"></script>',
    [ 'ad_create'=> ['<script src="{urlPath}/{templateFolder}/js/create.js"></script>','<script src="{urlPath}/{templateFolder}/js/dropzone/dropzone.min.js"></script>','<script src="{urlPath}/{templateFolder}/js/jquery-ui.min.js"></script>','<script src="{urlPath}/{templateFolder}/js/jquery.ui.touch-punch.min.js"></script>'] ],
    [ 'ad_update'=> ['<script src="{urlPath}/{templateFolder}/js/create.js"></script>','<script src="{urlPath}/{templateFolder}/js/dropzone/dropzone.min.js"></script>','<script src="{urlPath}/{templateFolder}/js/jquery-ui.min.js"></script>','<script src="{urlPath}/{templateFolder}/js/jquery.ui.touch-punch.min.js"></script>'] ],
        [ 'ad_view'=> ['<script src="{urlPath}/{templateFolder}/js/view.js"></script>'] ],
    [ 'profile'=> ['<script src="{urlPath}/{templateFolder}/js/user.js"></script>'] ],
    [ 'chat'=> ['<script src="{urlPath}/{templateFolder}/js/user.js"></script>'] ],
    [ 'catalog'=> ['<script src="{urlPath}/{templateFolder}/js/catalog.js"></script>'] ],
    [ 'blog'=> ['<script src="{urlPath}/{templateFolder}/js/blog.js"></script>'] ],
    [ 'blog_view'=> ['<script src="{urlPath}/{templateFolder}/js/blog.js"></script>'] ],
    [ 'index'=> ['<script src="{urlPath}/{templateFolder}/js/index.js"></script>'] ],
    [ 'map'=> ['<script src="{urlPath}/{templateFolder}/js/map.js"></script>'] ],
    [ 'order'=> ['<script src="{urlPath}/{templateFolder}/js/order.js"></script>'] ],
    [ 'shop'=> ['<script src="{urlPath}/{templateFolder}/js/shop.js"></script>','<script src="{urlPath}/{templateFolder}/js/ckeditor5-inline/ckeditor.js"></script>','<script src="{urlPath}/{templateFolder}/js/ckeditor5-inline/translations/{lang}.js"></script>'] ],
    [ 'shops'=> ['<script src="{urlPath}/{templateFolder}/js/shops.js"></script>'] ],
        [ 'promo'=> ['<script src="{urlPath}/{templateFolder}/js/summernote/summernote-lite.js"></script>','<script src="{urlPath}/{templateFolder}/js/summernote/summernote.min.js"></script>','<script src="{urlPath}/{templateFolder}/js/summernote/summernote-bs4.js"></script>','<script src="{urlPath}/{templateFolder}/js/summernote/lang/summernote-ru-RU.min.js"></script>','<script src="{urlPath}/{templateFolder}/js/minicolors/jquery.minicolors.min.js"></script>'] ],
   ],
   ...
   "sms_services" => [
        ...
        "smsc.ru" => [ "url" => "https://smsc.ru", "param" => "login:pass", "country" => "Россия", "label" => true ],
        "smsc.kz" => [ "url" => "https://smsc.kz", "param" => "login:pass", "country" => "Казахстан", "label" => true ],
