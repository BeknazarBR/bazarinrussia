...
<html lang="<?php echo getLang(); ?>">
  ...
  <body data-prefix="<?php echo $config["urlPrefix"]; ?>" data-header-sticky="true" data-type-loading="<?php echo $settings["type_content_loading"]; ?>" >
    ...
    <div class="container" >
       ...
       <?php
       $outParent = $CategoryBoard->outParent($getCategoryBoard, [ "tpl_parent" => '<div class="col-lg-3 col-6 col-md-4 col-sm-4" ><a {ACTIVE} href="{PARENT_LINK}">{PARENT_NAME} ...{COUNT_AD}</a></div>', "tpl" => '{PARENT_CATEGORY}', "category" => $data["category"] ]);
       ?>
