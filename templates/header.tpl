   ...
   <div class="header-wow-sticky-static" >
       ...
       <div class="container" >
           ...
           <div class="row" >
               ...
               <div class="<?php if($settings["marketplace_status"] && $settings["visible_lang_site"]){ echo 'col-lg-5'; }else{ echo 'col-lg-6'; } ?> col-md-5 col-sm-5" >
               ...
               <div class="<?php if($settings["marketplace_status"] && $settings["visible_lang_site"]){ echo 'col-lg-5'; }else{ echo 'col-lg-4'; } ?> col-md-5 col-sm-5 text-right header-wow-sticky-list" >
