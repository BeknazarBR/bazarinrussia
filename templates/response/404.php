...
<head>
    ...
    <link href="<?php echo $config["urlPath"]; ?>/<?php echo $config['template_folder']; ?>/css/line-awesome.min.css" rel="stylesheet">
...
<div class="img" >
    <div class="container" >
    	...
    	<img src="<?php echo $config["urlPath"]; ?>/<?php echo $config['template_folder']; ?>/images/word_18_2875628.png" >
